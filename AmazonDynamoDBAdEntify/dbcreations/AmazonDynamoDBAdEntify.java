    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            CreateTableRequest createTableRequest = new CreateTableRequest().withTableName(tableName)
                .withKeySchema(new KeySchema(new KeySchemaElement().withAttributeName("RowNumber").withAttributeType("N")))
            ...
            // Add an item
//            Map<String, AttributeValue> item = newItem(1, "Shekar Pasumarthi", (long)100, (long)200, "***");
//            PutItemRequest putItemRequest = new PutItemRequest(tableName, item);
//            PutItemResult putItemResult = dynamoDB.putItem(putItemRequest);
//            System.out.println("Result: " + putItemResult);
//
//            // Add another item
//            item = newItem(2, "Ed Mondragan", (long)300, (long)400, "$$$$");
